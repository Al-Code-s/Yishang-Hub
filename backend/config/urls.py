...
urlpatterns = [
    ...
    path(f"{API_PREFIX}/mes/", include("apps.mes.urls")),
    path(f"{API_PREFIX}/qms/", include("apps.qms.urls")),
    path(f"{API_PREFIX}/equipment/", include("apps.equipment.urls")),
    path(f"{API_PREFIX}/ems/", include("apps.ems.urls")),
    path(f"{API_PREFIX}/iot/", include("apps.iot.urls")),
    path(f"{API_PREFIX}/ehs/", include("apps.ehs.urls")),
    path(f"{API_PREFIX}/logistics/", include("apps.logistics.urls")),
